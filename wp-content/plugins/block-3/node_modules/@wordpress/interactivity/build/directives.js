...
exports.routerRegions = exports.default = void 0;
 ...
 */
const routerRegions = exports.routerRegions = new Map();
var _default = () => {
  // data-wp-context
  ...
  (0, _hooks2.directive)('each', ({
    ...
    for (const item of iterable) {
      ...
      const itemContext = (0, _proxies.proxifyContext)((0, _proxies.proxifyState)(namespace, {
        [itemProp]: item
  ...
  (0, _hooks2.directive)('router-region', ({
    directives: {
      'router-region': routerRegion
    }
  }) => {
    const entry = routerRegion.find(_hooks2.isDefaultDirectiveSuffix);
    if (!entry) {
      return;
    }
    const regionId = typeof entry.value === 'string' ? entry.value : entry.value.id;
    if (!routerRegions.has(regionId)) {
      routerRegions.set(regionId, (0, _signals.signal)());
    }
    ...
    if (vdom && typeof vdom.type !== 'string') {
      ...
      const previousScope = (0, _scopes.getScope)();
      return (0, _preact.cloneElement)(vdom, {
        previousScope
      });
    }
    return vdom;
